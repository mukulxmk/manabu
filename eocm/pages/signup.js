...
//         <Link href={'/login'}><p className="mt-2 text-center text-sm text-gray-600 ">Or<a  className="font-medium text-pink-600 hover:text-pink-500 cursor-pointer"> Login </a></p></Link>
//       </div>
  ...
  return (
    <>
      ...
      <div className="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8">
          <div>
            <h2 className="mt-6 text-center text-3xl tracking-tight font-bold text-gray-900">Sign Up</h2>
            <p className="mt-2 text-center text-sm text-gray-600">
              Or
              <Link href={'login'}><a href="#" className="font-medium text-rose-600 hover:text-rose-500"> Sign in to existing account</a></Link>
            </p>
          </div>
